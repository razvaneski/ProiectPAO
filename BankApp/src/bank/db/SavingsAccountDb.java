...
public class SavingsAccountDb {
    ...
    public void update(SavingsAccount newSavingsAccount) {
        try {
            String query = "UPDATE SavingsAccounts SET amount = ?, CNP = ?, startDate = ?, endDate = ?, interestRate = ? WHERE IBAN = ?";
            PreparedStatement preparedStmt = connection.prepareStatement(query);
            preparedStmt.setDouble(1, newSavingsAccount.getAmount());
            preparedStmt.setString(2, newSavingsAccount.getCustomerCNP());
    ...
    public void create(SavingsAccount savingsAccount) {
        try {
            String query = "INSERT INTO SavingsAccounts (IBAN, swift, amount, CNP, startDate, endDate, interestRate) VALUES (?, ?, ?, ?, ?, ?, ?)";
            PreparedStatement preparedStmt = connection.prepareStatement(query);
            ...
            preparedStmt.setString(4, savingsAccount.getCustomerCNP());
